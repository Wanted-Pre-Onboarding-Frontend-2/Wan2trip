...
const Result = () => {
  ...
  return (
    <Layout>
      ...
      <div className="lg:flex lg:p-10 lg:bg-white sm:p-0">
        <div className="lg:flex-col lg:w-5/12 bg-yellow-500 sm:w-full absolute h-20">
          <div className="lg:bolck sm:hidden">
            <div
        ...
        <div className="w-9/12 border-black px-50 bg-blue-500 sm:w-full">
          <div
            className="relative h-24 bg-white divide-y rounded shadow-md divide-slate-200 shadow-none divide-y-0
          sm:mt-20"
          >
            <Sort />
          </div>
